...
sys.path.append(str(Path(__file__).parent.parent / 'continuity_omega' / 'continuity_legacy'))
...
def test_omega_parity_functional(tmp_path):
    ...
    (repo_root / '.continuity' / 'DECISIONS_LOG.md').write_text("# Decisions", encoding='utf-8')
