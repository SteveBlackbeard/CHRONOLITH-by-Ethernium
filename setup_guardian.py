...
# CONTINUITY LEGACY: Guardian Setup (v1.0.0)
# -------------------------------------------------------------
...
def main():
    print("==========================================================")
    print(" CONTINUITY LEGACY: SENTINEL GUARDIAN SETUP ")
    print("==========================================================")
