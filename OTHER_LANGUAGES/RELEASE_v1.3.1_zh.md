...
## 🏛 三层生态系统
Continuity 现在由三个专业版本构成：
- **[Continuity Legacy Lite](https://github.com/SteveBlackbeard/CONTINUITY-LEGACY-by-Ethernium/tree/main/continuity-lite)** (v1.3.1): **零摩擦守护者**。为速度和日常开发者使用而优化。
- **[Continuity Legacy Pro](https://github.com/SteveBlackbeard/CONTINUITY-LEGACY-by-Ethernium/tree/main/continuity)** (v1.3.1): **战术引擎**。具有安全审计的工业级边境守卫。
- **[Continuity Legacy Omega](https://github.com/SteveBlackbeard/CONTINUITY-LEGACY-by-Ethernium/tree/main/continuity-omega)** (v1.3.1): **企业级神谕**。高级 RAG、认知地图和主动影响分析。
...
- **认知洞察 (仅 Omega)**: 交互式 HTML 决策地图和对比影响警报。
- **全球意识**: **9种语言** (EN, ES, ZH, JA, RU, FR, IT, DE, PT) 的完整文档和 CLI 支持。
- **钻石清洁**: 深度清除编码错误 (乱码)。
...
## 📊 技术规格 (硬件配置文件)
每个版本针对特定资源进行了优化：
- **Lite**: 超低资源 (<100MB RAM，无依赖)。
- **Pro**: 标准工作站 (推荐 4GB RAM)。
- **Omega**: 企业级怪兽 (RAG 和图处理推荐 8GB-16GB RAM)。
...
## 🧠 Omega 版本：认知洞察
**Omega 版本** 是我们的企业级层。它提供可视化、交互式的决策谱系和语义影响分析，以防止架构漂移。此版本代表了专业上下文保存的巅峰。

**OMEGA 仪表板可视化** *<sub><sup>(开发中)</sup></sub>*

---
_Continuity：保护您软件的逻辑谱系。_