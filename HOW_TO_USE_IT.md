# Chronolith: Guía Maestra de Operación 🛰️

Esta guía detalla el despliegue industrial de **Chronolith**, desde la instalación base hasta el enlace de paridad con proyectos soberanos (nuevos o existentes).
...
## 3. 🧬 Enlazando Chronolith a un Proyecto
...
2. **Pre-push Audit**: Al intentar hacer `git push`, el hook local de Chronolith verifica la integridad del ADN.
...
- `token_sentinel.py` (CLI: `chronolith-tokens`): Audita el peso cognitivo de los archivos para optimizar el contexto del LLM.
