...
CANONICAL_HEADERS = {
    ...
    ".chronolith/BOOT_SEQUENCE.md": "# BOOT SEQUENCE (Required First Response Pattern) 🚀",
    "PROJECT_CONTEXT.md": "# PROJECT CONTEXT (SYSTEM ROLE: Context Chronolith Rules) 📜",
}
...
def main() -> None:
    ...
    heal_document(root / ".chronolith/BOOT_SEQUENCE.md", ["BOOT SEQUENCE", "Required First Response Pattern"])
    heal_document(root / "PROJECT_CONTEXT.md", ["PROJECT_CONTEXT", "SYSTEM ROLE:", "CONTEXT CHRONOLITH RULES:"])
