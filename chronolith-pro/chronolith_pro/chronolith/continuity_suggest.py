...
def main() -> None:
    parser = argparse.ArgumentParser(description="Suggest chronolith updates based on recent changes.")
    ...
    echo(f"\n{Color.BOLD}--- CHRONOLITH SUGGESTION ENGINE ---{Color.END}")
    ...
    prompt = f"""
[CHRONOLITH PROMPT TEMPLATE]
I have made the following changes in the project:
{diff_summary}

Based on this, please help me update my chronolith files:
