...
from chronolith_pro.chronolith.zip_bridge import create_portal_zip, verify_portal
...
def scan(
    ...
    if total_tokens > 20000:
        console.print("[bold yellow][!] SUGGESTION: Run 'chronolith-tokens optimize' to apply Ethernium Nucleotide Encoding (ENE) (x10 efficiency).[/bold yellow]")
