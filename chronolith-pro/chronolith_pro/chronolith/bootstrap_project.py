...
def bootstrap_project(
    ...
    """Initializes a new CHRONOLITH repository structure.
    ...
    if with_vector or with_graph:
        ext_root = repo_root / "tools" / "chronolith" / "extensions"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Personalize the Chronolith starter for a new project.")
