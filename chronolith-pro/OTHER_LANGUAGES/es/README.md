...
1. **Instalación**: Copia la carpeta `tools/chronolith/` a tu proyecto.

2. **Inicialización Inteligente (Caja de Cristal)**:

```powershell

python tools/chronolith/bootstrap_project.py --repo-root . --project-name "Mi Proyecto" --project-slug mi_proyecto --discover
...
python tools/chronolith/bootstrap_project.py --project-name "IA Core" --project-slug ia_core --with-vector
