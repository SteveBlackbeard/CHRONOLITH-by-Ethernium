...
`CHRONOLITH` è un kit di avvio indipendente progettato per costruire progetti con continuità persistente, memoria canonica e un passaggio di consegne (handoff) ripetibile tra umani e operatori IA.
...
chronolith-legacy init "Il Mio Progetto"
...
python tools/chronolith/bootstrap_project.py --repo-root . --project-name "Il Mio Progetto" --project-slug il_mio_progetto
...
python tools/chronolith/bootstrap_project.py --repo-root . --project-name "Il Mio Progetto" --project-slug il_mio_progetto --enable-external-docs

```



## Protezione Automatica (Chronolith Guard)
