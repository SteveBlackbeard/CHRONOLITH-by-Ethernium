...
`CHRONOLITH` ist ein eigenständiges Starter-Toolkit für die Erstellung von Projekten mit persistenter Kontinuität, kanonischem Speicher und einer wiederholbaren Übergabe (Handoff) zwischen Menschen und KI-Operatoren.
...
chronolith-legacy init "Mein Projekt"
...
python tools/chronolith/bootstrap_project.py --repo-root . --project-name "Mein Projekt" --project-slug mein_projekt
...
python tools/chronolith/bootstrap_project.py --repo-root . --project-name "Mein Projekt" --project-slug mein_projekt --enable-external-docs

```



## Automatische Sicherheit (Chronolith Guard)
