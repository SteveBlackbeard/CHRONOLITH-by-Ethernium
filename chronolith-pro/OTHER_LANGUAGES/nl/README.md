...
`CHRONOLITH` is een onafhankelijke starter-toolkit voor het bouwen van projecten met persistente continuïteit, canoniek geheugen en een herhaalbare overdracht (handoff) tussen mensen en AI-operators.
...
chronolith-legacy init "Mijn Project"
...
python tools/chronolith/bootstrap_project.py --repo-root . --project-name "Mijn Project" --project-slug mijn_project
...
python tools/chronolith/bootstrap_project.py --repo-root . --project-name "Mijn Project" --project-slug mijn_project --enable-external-docs

```



## Automatische Beveiliging (Chronolith Guard)
