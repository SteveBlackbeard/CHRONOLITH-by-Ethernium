...
`CHRONOLITH` — это независимый стартовый набор для создания проектов с устойчивой непрерывностью, канонической памятью и повторяемой передачей дел (handoff) между людьми и ИИ-операторами.
...
## Автоматическая защита (Chronolith Guard)
