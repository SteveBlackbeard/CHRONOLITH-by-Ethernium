...
## Canonical Chronolith Artifacts
- `PROJECT_CONTEXT.md`
- `STATE.json`
- `ROADMAP.md`
- `.chronolith/BOOT_SEQUENCE.md`
...
Every relevant structural, canonical, or chronolith change must update:
1. `STATE.json`
2. `ROADMAP.md`
3. `.chronolith/LIVE_HANDOFF.md`

If the change sets a lasting rule or decision, also update:
4. `.chronolith/DECISIONS_LOG.md`

If the change completes a milestone, also update:
5. `.chronolith/TIMELINE.md`

## Mandatory Automation Closeout
After every relevant structural, canonical, or chronolith change, run:
