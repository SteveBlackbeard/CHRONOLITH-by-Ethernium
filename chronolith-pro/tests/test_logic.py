#!/usr/bin/env python3
"""
test_logic.py — CHRONOLITH Pro Tests
===========================================
Advanced Unit Tests for the Chronolith Framework.

Covers:
- Decision Engine momentum parsing
- Chronolith Cycle edge cases
...
import sys
# Add tools/chronolith to python path for testing
...
class TestDecisionEngine(unittest.TestCase):
    ...
    def test_tactical_directive_extraction(self):
        ...
        chronolith_dir = self.root_path / ".chronolith"
        chronolith_dir.mkdir(parents=True)
        
        handoff_file = chronolith_dir / "LIVE_HANDOFF.md"
