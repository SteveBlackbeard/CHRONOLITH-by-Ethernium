# Security Policy — Continuity Pro

Continuity Pro is a cryptographic integrity layer for a project's canonical
...
The latest `3.x` release receives security fixes. Continuity Pro is pre-1.0 in
