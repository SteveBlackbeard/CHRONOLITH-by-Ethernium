...
```text
Continuity Legacy v3.0.3 turns the Python framework into a governed continuity platform: explicit rulebook, feature registry, live handoff, golden baseline verification, health guard, and clean separation from CONEKTA.
```
