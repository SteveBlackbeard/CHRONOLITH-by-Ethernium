...
This is not a dashboard release. Conekta Dev by Ethernium is a separate product and repository. Robin Hood by Ethernium is an external tool, documented separately and not required for this release.
...
- Dashboard: excluded from Legacy; use Conekta Dev by Ethernium as a separate repo.
...
```text
Continuity Legacy v3.0.3 turns the Python framework into a governed continuity platform: explicit rulebook, feature registry, live handoff, golden baseline verification, health guard, and clean separation from Conekta Dev.
```
...
- Conekta Dev remains external; Legacy stays a Python framework.
