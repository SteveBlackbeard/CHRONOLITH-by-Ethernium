...
"""
    ...
    draft += """- **General**: Every significant change must be reflected in the `.chronolith/` surfaces.
- **Verification**: Run `python tools/chronolith/run_chronolith_cycle.py` before any push.
