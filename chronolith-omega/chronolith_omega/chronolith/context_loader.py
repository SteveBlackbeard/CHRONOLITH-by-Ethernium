...
def _iter_internal_docs(repo_root: Path, config: dict) -> list[tuple[str, Path, str]]:
    return [
        ...
        ("chronolith", chronolith_doc_path(repo_root, "CONTEXT_CHRONOLITH.md", config), "text"),
        ("boot", chronolith_doc_path(repo_root, "BOOT_SEQUENCE.md", config), "text"),
        ("handoff", chronolith_doc_path(repo_root, "LIVE_HANDOFF.md", config), "text"),
        ("decisions_log", chronolith_doc_path(repo_root, "DECISIONS_LOG.md", config), "text"),
        ("timeline", chronolith_doc_path(repo_root, "TIMELINE.md", config), "text"),
    ]
