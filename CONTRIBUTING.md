...
- Follow the [HOW_TO_USE_IT.md](HOW_TO_USE_IT.md) guide for local setup.
...
3.  **Contact Points**:
    - **Email**: [etherniumcorp@outlook.com](mailto:etherniumcorp@outlook.com)
    - **X (Twitter)**: [@ethernium](https://x.com/ethernium) | [@SteveBlackbeard](https://x.com/SteveBlackbeard)
    - **GitHub**: [SteveBlackbeard](https://github.com/SteveBlackbeard)

Once authorized, your key will be added to the `chosen_ones.json` registry, allowing you to use `tokenator open-ctx` on `.locked` nucleotides.
